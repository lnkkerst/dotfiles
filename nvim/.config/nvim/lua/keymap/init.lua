...
local plug_map = {
    ...
    ["n|gx"] = map_cr("Lspsaga code_action"):with_noremap():with_silent(),
    ["x|gx"] = map_cu("Lspsaga range_code_action"):with_noremap():with_silent(),
    ["n|K"] = map_cr("Lspsaga hover_doc"):with_noremap():with_silent(),
    ["n|go"] = map_cr("Lspsaga show_line_diagnostics"):with_noremap()
        :with_silent(),
    ["n|gj"] = map_cr("Lspsaga diagnostic_jump_next"):with_noremap()
        :with_silent(),
    ["n|gk"] = map_cr("Lspsaga diagnostic_jump_prev"):with_noremap()
        :with_silent(),
    -- -- Packer
