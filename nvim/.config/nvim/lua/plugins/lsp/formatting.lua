...
vim.cmd(
    [[command! FormatDisable lua require'modules.completion.formatting'.formatToggle(true)]])
vim.cmd(
    [[command! FormatEnable lua require'modules.completion.formatting'.formatToggle(false)]])
